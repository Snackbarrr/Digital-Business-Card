    ...
    <>
      ...
      >
        ...
        >
                ...
                >
                  ...
                  >
                    <Image
                      ...
                      style={{
                        backfaceVisibility: "hidden",
                        // default tiles are grayscale; this is overridden when focused (see CSS in step 3)
                        filter: `var(--image-filter, ${grayscale ? "grayscale(1)" : "none"})`,
                      }}
                      // optional: prioritize first few images
                      priority={i < 4}
                    />
                  </div>
                </div>
          ...
          <div
            className="absolute inset-0 m-auto z-[3] pointer-events-none hidden"
            style={{
          ...
          <div
            className="absolute left-0 right-0 top-0 h-[120px] z-[5] pointer-events-none rotate-180 hidden"
            style={{
              background: `linear-gradient(to bottom, transparent, var(--overlay-blur-color, ${overlayBlurColor}))`,
            }}
          />
          <div
            className="absolute left-0 right-0 bottom-0 h-[120px] z-[5] pointer-events-none hidden"
            style={{
              background: `linear-gradient(to bottom, transparent, var(--overlay-blur-color, ${overlayBlurColor}))`,
            }}
          />
