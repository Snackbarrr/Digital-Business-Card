      ...
      <main className="max-w-6xl mx-auto pt-20 pb-16 px-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7">
            <div className="relative w-full aspect-[4/3] rounded-2xl overflow-hidden bg-gray-300">
              <Image
            ...
            {product.images?.length > 1 && (
              <div className="mt-3 grid grid-cols-3 sm:grid-cols-4 gap-3">
                {product.images.slice(1).map((img, i) => (
                  <div
                    key={i}
                    className="relative w-full aspect-[4/3] rounded-xl overflow-hidden bg-gray-500"
                  >
          ...
          <div className="lg:col-span-5 flex flex-col gap-6 ">
            ...
            <div className="rounded-2xl border border-gray-400 p-5">
