...
const UrbanTailorPage = () => {
  const images = [
    { id: 1, src: "https://storage.googleapis.com/spurofthemoment/Portfolio/urbantailor/Threemansuitbrick.avif", alt: "Three men in suits against brick wall" },
    ...
    { id: 6, src: "https://storage.googleapis.com/spurofthemoment/Portfolio/urbantailor/Balledupmoses.avif", alt: "Moses in relaxed pose" },
    ...
    { id: 9, src: "https://storage.googleapis.com/spurofthemoment/Portfolio/urbantailor/Richardmosesoutdoor.avif", alt: "Richard and Moses outdoor shot" },
    ...
    { id: 17, src: "https://storage.googleapis.com/spurofthemoment/Portfolio/urbantailor/Urbantailorbags.avif", alt: "UrbanTailor bags" },
    { id: 18, src: "https://storage.googleapis.com/spurofthemoment/Portfolio/urbantailor/Editorial.avif", alt: "Editorial" },
    { id: 19, src: "https://storage.googleapis.com/spurofthemoment/Portfolio/urbantailor/Foliage.avif", alt: "Foliage" },
    { id: 20, src: "https://storage.googleapis.com/spurofthemoment/Portfolio/urbantailor/Harbour.avif", alt: "Harbour" },
    { id: 21, src: "https://storage.googleapis.com/spurofthemoment/Portfolio/urbantailor/Purposeful.avif", alt: "Purposeful" },
    { id: 22, src: "https://storage.googleapis.com/spurofthemoment/Portfolio/urbantailor/Restaurant.avif", alt: "Restaurant" },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="px-8 py-5 border-b border-gray-200 flex justify-between items-end gap-4">
        <div>
          <h1 className="text-2xl font-semibold text-gray-900">UrbanTailor Suits</h1>
      ...
      <main
        ...
        style={{
          columnGap: "8px", // fine horizontal spacing
        }}
      >
        <style jsx>{`
          figure {
