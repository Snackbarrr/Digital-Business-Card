...
const UPDATES = [
  {
    date: "2025-03-08",
    title: "Gift Shop is live",
    body:
      "Launched three collections—Prints, Collaborations, and Merch. Limited runs and small-batch drops.",
  ...
  },
  {
    ...
    body:
      "Extended the series with seaside portraits and detail studies. Focused on minimal branding and posture-led stories.",
  ...
  },
  {
    ...
    body:
      "Looking to partner with thoughtful makers and labels on story-led imagery and small objects.",
